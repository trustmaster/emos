...
## Working with Shared Folders and Shared Drives

When listing files in a shared folder or shared drive, the API silently returns empty results unless you include these three params:
...
Example — list spreadsheets in a shared folder:
